...
| `properties.json` | 5 properties | District-owned/leased real estate that is **not** an operating school — admin buildings, leased-out former campuses (incl. the Hawes campus at 909 Roosevelt, shared by Rocketship charter + Building Kidz + Touchstone Learning), storage. Keyed by address; use to resolve a district site named only by street address. |
