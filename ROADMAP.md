...
- [x] ~~**Get `agenda-attachments.json` back on a schedule.**~~ — resolved 2026-09-07 by retiring it.
  It was generated by a manual step, covered only June 2025 - June 2026, and filed 173 attachments
  under the wrong meeting. `data/attachment-index.json`, derived from `meetings-data.json` in the
  pipeline, replaces it with the whole corpus and attribution that matches the meeting record.
