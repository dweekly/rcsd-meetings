...
- [ ] **Alignment-shift repeat failures** (2026-08-18): ~6 meetings (2020-04-22, 2020-06-17, 2020-07-22, 2020-09-09, 2020-09-30, 2021-02-10) failed translate-transcripts' digit-alignment guard on claude-sonnet-4-6 — each paid for (~$0.5–1/meeting) then discarded, retried next run. 2026-08-18: Sonnet 5 swap validated on 2020-04-22 (passed the guard, 0 errors); remaining five expected to clear in the supervised full drain. If any still fail on Sonnet 5: retry that meeting with smaller batches (shift risk grows with batch length) and add a persistent skip-list/backoff.
